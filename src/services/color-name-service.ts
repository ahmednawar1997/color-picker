...
export let ntc = {
    ...
    init: () => {
        ...
        for (let i = 0; i < ntc.names.length; i++) {
            ...
            ntc.names[i].push(rgb[0].toString(), rgb[1].toString(), rgb[2].toString(), hsl[0].toString(), hsl[1].toString(), hsl[2].toString());
        }


        console.log('in color name');
    },
    ...
    name: (color: string) => {
        ...
        for (let i = 0; i < ntc.names.length; i++) {
            ...
            ndf1 = Math.pow(r - Number(ntc.names[i][2]), 2) + Math.pow(g - Number(ntc.names[i][3]), 2) + Math.pow(b - Number(ntc.names[i][4]), 2);
            ndf2 = Math.pow(h - Number(ntc.names[i][5]), 2) + Math.pow(s - Number(ntc.names[i][6]), 2) + Math.pow(l - Number(ntc.names[i][7]), 2);
            ndf = ndf1 + ndf2 * 2;
            if (df < 0 || df > ndf) {
                df = ndf;
                cl = i;
